        ...
        if(user){
            ...
            if(address){
                if(user.address[0] === ""){
                    ...
                    updated = await Users.findByIdAndUpdate(user._id, {address})
                }else {
                    updated = await Users.findByIdAndUpdate(user._id, {$push: {address}})
                }
            }
            if(phone){
                updated = await Users.findByIdAndUpdate(user._id, {phone})
            }
